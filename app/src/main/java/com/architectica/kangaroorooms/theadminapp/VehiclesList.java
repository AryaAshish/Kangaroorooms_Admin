...
public class VehiclesList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(VehiclesList.this);
    ...
    public void assignValuesFromFirebase(DatabaseReference databaseReference){
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot snapshot : chidSnap.getChildren()){
                        ...
                        for (DataSnapshot snapshot1 : addressSnapshot.getChildren()){
                            ...
                            if (LoginActivity.isMainAdmin == true){
                                ...
                                if (snapshot1.child("status").getValue(String.class).equals("Verified")){
                                    ...
                                    vendorUids.add(snapshot1.child("VendorUid").getValue(String.class));
                ...
                mHotelAdapter = new HotelAdapter(VehiclesList.this,mVehicleImages,VendorNames,mCity,vehicleType,mVehicleNames,
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(VehiclesList.this, "error loading data.", Toast.LENGTH_SHORT).show();
            }
        });
    }
