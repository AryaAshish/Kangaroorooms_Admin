...
public class ImageAdapter extends RecyclerView.Adapter<ImageAdapter.ImageItemViewHolder> {
    ...
    public class ImageItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageItemViewHolder(View itemView,ImageAdapter adapter) {
            ...
            setMainPicSymbol = (ImageView)itemView.findViewById(R.id.setMainPicSymbol);
            mAdapter = adapter;
    ...
    public void onBindViewHolder(final ImageAdapter.ImageItemViewHolder holder, final int position) {
       ...
       /* holder.mHotelCity.setText(mCurrentCity);
        ...
        holder.setMainPicSymbol.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                //set that pic as main pic

                FirebaseDatabase.getInstance().getReference(HotelAdapter.city + "/" + HotelAdapter.type + "/" + HotelAdapter.vehicleName).child("VehiclePhoto").setValue(mCurentHotelImage);

                DatabaseReference vendorUpdate = FirebaseDatabase.getInstance().getReference("Vendors/" + EditActivity.vendorUid + "/UploadedVehicles");
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot child : dataSnapshot.getChildren()){
                            ...
                            if (HotelAdapter.vehicleName.equals(child.child("VehicleName").getValue(String.class)) && HotelAdapter.type.equals(child.child("VehicleType").getValue(String.class))){
                               ...
                               child.child("VehiclePhoto").getRef().setValue(mCurentHotelImage);
